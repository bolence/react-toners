...
Route::middleware('auth:api')->get('orders/copy_orders', [App\Http\Controllers\Api\ApiOrdersController::class, 'copy_order_from_last_month']);
...
Route::middleware('auth:api')->post('reminders', [App\Http\Controllers\Api\ApiReminderDateController::class, 'store']);
